...
def cal_house_price_by_year(year_groupby,aera_groupby,title:str):
    ...
    plt.legend(bbox_to_anchor=(1.0, 0.7))  # The line has a corresponding name to take effect
    plt.xticks(x)
